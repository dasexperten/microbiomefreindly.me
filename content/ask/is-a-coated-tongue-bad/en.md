---
title: "What that coating on your tongue is actually made of"
meta: "A white film on the tongue is mostly your own shed cells and bacteria. What it is made of, why it smells, when it is normal, and what trials show reduces it."
kicker: "Ask Magnus"
type: ask
topic: oral
lang: en
...
keyFacts:
  - fact: "The coating is food remnants, shed epithelial cells and anaerobic bacteria held on roughly 25 cm² of irregular tongue surface."
    source: s1
  - fact: "In 268 systemically healthy young adults, a thin coating was the heaviest thickness score recorded for 92.7 % of men and 87.4 % of women — 90.7 % of the whole group."
    source: s2
  - fact: "Sampling the tongue dorsum of 19 volunteers recovered 10⁶–10⁸ CFU per sample, including Gram-negative anaerobes and sulphur-compound producers."
    source: s3
  - fact: "About 85 % of bad breath comes from inside the mouth; 10 % is ear-nose-throat and 5 % gastrointestinal or endocrine."
    source: s1
  - fact: "In the current Cochrane review of 44 trials and 1 809 participants, mechanical tongue cleaning beat no cleaning by 0.20 organoleptic points — very low-certainty evidence."
    source: s5
  - fact: "In older adults with reduced saliva, tongue-coating index was higher and the adjusted odds of oral Candida colonisation were 4.36 times greater."
    source: s8
faq:
  - q: "Should I scrape my tongue every day?"
    a: "If bad breath bothers you, yes — gently, and expect a small effect. Only daily scraping lowered the next-morning bacterial load on the tongue in the Bordas crossover study; a single clean was transient [s3]. The Cochrane review of halitosis interventions rates the evidence for mechanical tongue cleaning versus none at very low certainty, with a difference of 0.20 organoleptic points from two small trials [s5]. That is a real effect, not a large one."
  - q: "Does scraping make the coating come back thicker?"
  ...
  - q: "When should I show my tongue to a clinician?"
    a: "When a white layer wipes off and leaves raw, red or sore tissue underneath, when the coating is one-sided, painful, ulcerated or bleeding, when the papillae look elongated and brown or black, or when it appears alongside a persistently dry mouth. Those are the pictures a tongue-disease review separates from ordinary coating [s11], and reduced saliva itself is linked to both heavier coating and Candida colonisation [s8]."
  - q: "Will a probiotic clear my tongue?"
    a: "Not on current evidence. A meta-analysis of seven randomised trials found probiotics improved judged breath scores in the short term — standardised mean difference −0.58 — and cut sulphur compounds slightly, but found no significant effect on tongue-coating scores at all [s10]. Breath and coating are related, and they are not the same outcome."
  - q: "Does a coated tongue mean something is wrong with my gut?"
    a: "Usually not. Roughly 85 % of bad breath is generated inside the mouth, and only about 5 % traces to gastrointestinal or endocrine causes [s1]. The tongue coating and periodontal disease are the two main sources of the sulphur compounds you smell [s12]. Start with the mouth."
sources:
  - id: s1
...
And **bad breath you cannot fix by cleaning your tongue** is not automatically a stomach problem. About 85 % of halitosis originates intra-orally, roughly 10 % is ear-nose-throat and about 5 % gastrointestinal or endocrine [s1]. Search the mouth first, gums included.

## What actually reduces it, and by how much

Now the part where I have to be honest about effect sizes.

**Mechanical cleaning works, modestly.** The current Cochrane review of halitosis interventions pooled 44 trials and 1 809 participants; for mechanical tongue cleaning versus none, dentist-rated organoleptic scores improved by 0.20 points, 95 % CI 0.07 to 0.34, from two trials with 46 participants, rated very low-certainty evidence [s5]. The earlier Cochrane review dedicated to tongue scraping, since folded into that one, found just two trials with 40 participants and judged them too heterogeneous to pool; in one of them volatile sulphur compounds fell 42 % with a tongue cleaner, 40 % with a scraper and 33 % with a toothbrush — and in none of the groups could the reduction still be detected 30 minutes afterwards [s4].

**Repetition is what makes it stick.** In Bordas's crossover study, brushing alone significantly reduced only *S. salivarius*; brushing plus scraping reduced all four bacterial categories; and only daily scraping lowered the next-morning baseline load by day 4 [s3].

**It may do more than freshen breath.** Acar and colleagues randomised 36 gingivitis patients after scaling and polishing; at 7 days, only the arm using a tongue scraper improved on sulphur compounds, organoleptic score and tongue-coating score, and gingival crevicular fluid IL-1β and IL-8 fell in that arm [s6]. Small, short, single-centre; the authors call for further studies before judging clinical relevance.

**Taste may improve.** Sixty-five healthy participants used a tongue brush for 14 days; among the 50 non-smokers, Winkel Tongue Coating Index values fell and total taste scores rose, and the 15 smokers improved on taste scores too [s9] — but with no control group, that is a lead, not a finding.

**Probiotics are not the answer here.** A meta-analysis of seven randomised trials found probiotics improved judged breath scores in the short term, standardised mean difference −0.58, 95 % CI −0.87 to −0.30, and reduced sulphur compounds slightly, −0.26, 95 % CI −0.51 to −0.01 — but showed no significant effect on tongue-coating scores [s10].

## What I would do

Clean the back of your tongue once a day, gently, as part of brushing. Expect a modest, short-lived reduction in odour that only holds if you keep doing it [s3][s4]. Take the tongue seriously as a signal only when it changes character — wipes off raw, turns one-sided, hurts, or arrives with a mouth that has gone dry.

...
sources: []
images:
  card: "/assets/img/mbf/hubs/enzymes/enzymes-card-pl.webp"
  cardLine: "Czy enzymy zabijają bakterie?"
  cardAlt: "Czy enzymy zabijają bakterie? — kobieta kroi ananasa i papaję przy stole w późnym porannym słońcu"
  og: "/assets/img/mbf/hubs/enzymes/enzymes-og-pl.jpg"
  preview: "/assets/img/mbf/hubs/enzymes/enzymes-preview.webp"
  previewAlt: "Ilustracja: zwinięte białko enzymu trzyma w rowku łańcuch cukrowy i przecina jedno ogniwo, zaznaczone koralowo, w ciepłym świetle od tyłu"
  plate: "/assets/img/mbf/hubs/enzymes/enzymes-plate-pl.webp"
  plateLines: "Najpierw — sieć cukrów trzyma płytkę · Potem — enzym tnie jedno ogniwo · Efekt — sieć opada, komórki żyją"
  hero: "/assets/img/mbf/hubs/enzymes/enzymes-hero.webp"
  heroAlt: "Ilustracja: łańcuszki okrągłych bakterii uwięzione w sieci łańcuchów cukrowych; białka enzymów tną te łańcuchy w limonkowych punktach, a uwolnione bakterie odpływają całe"
referral:
  product: ""
  mayaLog: ""
  benefitGate: ""

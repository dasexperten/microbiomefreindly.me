...
**1. Slug (ASCII, language-neutral):** `skin`
File names: `skin-preview` · `skin-hero`.

**2. Article title (EN) + one-line summary:** "The gut–skin axis: how the gut talks to your skin, how far" — gut bacteria shape the immune cells and metabolites that travel in the blood to the skin, and the skin's own microbes respond to that immune tone; eczema, acne and rosacea are associated with gut changes, not with bacteria travelling to the face.
...
- *Staphylococcus*: round cocci in small irregular grape-like clusters, sitting on the shingles.
- *Cutibacterium*: short, slightly irregular rods, some a little club-shaped at one end, lying single, in pairs or in small angled groups, gathered at the rim of the follicle opening and just inside it.
- The gut side (second frame): a single row of tall column-shaped lining cells with generic short rods and cocci above them; the hub names no gut species for this route, so none is implied.
- Metabolites (short-chain fatty acids, bile-acid derivatives, tryptophan products): tiny molecules, each a small cluster of a few linked beads.
- Immune cells trained in the gut: small round cells, mostly filled by one large round nucleus.
- Circulation: one translucent blood vessel, drawn as a clear tube carrying only molecules and immune cells. No bacteria inside it.
- The skin side (second frame): stacked layers of cells that flatten toward the top into the shingled surface, with the resident clusters of cocci and short rods on it.
...
- en preview alt: "Illustration: grape-like clusters of round bacteria on flat skin surface cells, and coral short rods at the rim of a pore"
...
- Cutibacterium, Staphylococcus, sebum, the follicle, circulating immune cells and metabolites are all named in the hub.
- The vessel carries molecules and immune cells only; the hub is explicit that bacteria do not travel to the face.
- The frames show a link, not a cause; nothing suggests a gut treatment for acne, eczema or rosacea.

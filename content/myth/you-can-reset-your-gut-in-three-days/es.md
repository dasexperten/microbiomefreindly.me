...
keyFacts:
  ...
  - fact: "Tras una combinación de cuatro días de meropenem, gentamicina y vancomicina, doce hombres sanos recuperaron una composición cercana a la inicial en torno a 1,5 meses, y sin embargo nueve especies comunes seguían siendo indetectables en la mayoría de ellos a los 180 días."
    source: s4
  - fact: "Dos tandas de ciprofloxacino redujeron la diversidad intestinal en los tres o cuatro días siguientes al inicio del fármaco; las comunidades empezaron a volver alrededor de una semana después de cada tanda, pero la vuelta fue a menudo incompleta."
    source: s5
faq:
  - q: "¿Entonces una limpieza de tres días no hace nada?"
    a: "Hace algo medible, y algo corto. En el ensayo cruzado de Nature de 2014, cinco días de dieta extrema movieron la comunidad en el plazo de un día desde que la comida llegó al intestino, y la comunidad volvió a su estructura original dos días después de terminar la dieta. Nada de lo publicado muestra que tres días produzcan una reconstrucción duradera."
  - q: "¿Cuánto tiene que durar un cambio de dieta para que se quede?"
    a: "Ningún ensayo ha publicado un umbral limpio, y no me lo voy a inventar. Lo que muestran las pruebas es la forma del problema: en el estudio de alimentación controlada de Science de 2011, la composición del día a día se movió en menos de 24 horas mientras la identidad del enterotipo se mantuvo estable durante todo el estudio de 10 días, y los enterotipos seguían los patrones alimentarios de largo plazo, no la semana del estudio."
  - q: "¿Los antibióticos sí reinician el intestino?"
    a: "No, y son la perturbación más fuerte que se ha aplicado de forma éticamente aceptable. En Nature Microbiology de 2018, doce hombres con cuatro días de tres antibióticos de último recurso se reconstruyeron hasta cerca de la composición inicial en torno a 1,5 meses, pero nueve especies que todos llevaban antes seguían faltando en la mayoría seis meses después. Eso es daño más recrecimiento, no una pizarra limpia."
  - q: "¿Un análisis de heces mostraría que mi reinicio funcionó?"
    a: "Una muestra tomada durante el protocolo puede muy bien dar una lectura distinta de otra tomada antes. La muestra tomada unos días después de parar es la prueba difícil, y los datos de reversión de Nature de 2014 sugieren que se parecería mucho a tu comunidad de siempre. Pregunta con qué compara tu análisis, y cuándo se tomó."
  - q: "¿Hay alguna situación en la que el intestino se reconstruya de verdad desde cero?"
    a: "Comiendo, no. Los ejemplos publicados de sustitución completa de la comunidad implican un trasplante fecal en un intestino alterado, que es un procedimiento clínico con sus propias indicaciones y riesgos, no un producto de estantería. Queda fuera de lo que ofrece un protocolo de tres días."
sources:
  - id: s1
  ...
  - id: s5
    ...
    pmid: "20847294"
images:
  card: "/assets/img/mbf/myth/you-can-reset-your-gut-in-three-days/you-can-reset-your-gut-in-three-days-card-es.webp"
  cardLine: "¿Tres días bastan?"
  cardAlt: "¿Tres días bastan? — una mujer junto a la ventana de su sala con la luz de la tarde, los brazos cruzados"
  og: "/assets/img/mbf/myth/you-can-reset-your-gut-in-three-days/you-can-reset-your-gut-in-three-days-og-es.jpg"
  preview: "/assets/img/mbf/myth/you-can-reset-your-gut-in-three-days/you-can-reset-your-gut-in-three-days-preview.webp"
  previewAlt: "Ilustración: bacterias intestinales gruesas en forma de bastón y parejas de células redondas pequeñas posadas en un trozo de fibra vegetal"
  plate: "/assets/img/mbf/myth/you-can-reset-your-gut-in-three-days/you-can-reset-your-gut-in-three-days-plate-es.webp"
  plateLines: "Primero — la comida mueve la mezcla en un día · Luego — dos días después vuelve atrás · Resultado — el 60 % de las cepas se queda años"
  hero: "/assets/img/mbf/myth/you-can-reset-your-gut-in-three-days/you-can-reset-your-gut-in-three-days-hero.webp"
  heroAlt: "Ilustración: dos filas de diez grupos de bacterias intestinales en el moco mientras llega la comida; en la fila posterior seis grupos siguen iguales y cuatro están sustituidos por recién llegados"
referral:
  product: ""
  mayaLog: ""
  benefitGate: ""
...
Empecemos por la prueba más fuerte de que la promesa no es simplemente un disparate. En 2014, David y sus colegas reclutaron a once voluntarios [s1] —diez en cada una de dos dietas extremas, nueve de ellos completando ambas ramas [s1]—: una dieta compuesta enteramente por productos animales y otra enteramente por vegetales, cada una durante cinco días seguidos [s1]. La comunidad se movió, y se movió deprisa: las diferencias de composición eran visibles un día después de que un colorante trazador mostrara que la dieta animal había llegado al intestino [s1]. Los microorganismos tolerantes a la bilis, entre ellos *Alistipes*, *Bilophila* y [*Bacteroides*](/bacteria/bacteroidota/), subieron con la dieta animal, mientras que los [Firmicutes](/bacteria/bacillota-firmicutes/) que fermentan polisacáridos vegetales —*Roseburia*, *Eubacterium rectale*, *Ruminococcus bromii*— bajaron [s1].

Wu y sus colegas habían cronometrado la misma velocidad tres años antes. En un estudio de alimentación controlada con diez sujetos [s2], la composición cambió de forma detectable en menos de 24 horas [s2] tras pasar a una comida rica en grasa y pobre en fibra, o pobre en grasa y rica en fibra.
...
Ahora la otra dirección, sacada del mismo trabajo. La microbiota intestinal de los sujetos volvió a su estructura original dos días después de terminar la dieta animal [s1]. Dos días. El cambio no sobrevivió a la dieta que lo había causado ni media semana laboral.

El grupo de Wu puso a prueba la capa más profunda y la encontró firme. La identidad del enterotipo —la configuración general, *Bacteroides* frente a *Prevotella*, en la que se sitúa cada persona— se mantuvo estable durante todo el estudio de 10 días [s2] mientras la composición del día a día se movía por debajo. Esos enterotipos seguían los patrones alimentarios de largo plazo [s2]: los años de comer, no la semana.
...
Palleja y sus colegas dieron a 12 hombres sanos [s4] una tanda de cuatro días [s4] de tres antibióticos de último recurso —meropenem, gentamicina y vancomicina— y los siguieron durante seis meses [s4]. La comunidad se desplomó, floreció de patobiontes y luego se reconstruyó: cerca de la composición inicial en torno a 1,5 meses [s4]. Pero nueve especies comunes presentes en todos los sujetos antes del tratamiento seguían siendo indetectables en la mayoría de ellos a los 180 días [s4].

Dethlefsen y Relman habían observado una versión más suave en tres personas a lo largo de diez meses [s5] que abarcaron dos tandas de ciprofloxacino. La diversidad cayó en los tres o cuatro días siguientes al inicio del fármaco [s5]. Las comunidades empezaron a volver alrededor de una semana después de terminar cada tanda [s5], pero la vuelta era a menudo incompleta [s5], y al final del estudio el intestino de cada persona se había estabilizado en una composición distinta de la de partida [s5].

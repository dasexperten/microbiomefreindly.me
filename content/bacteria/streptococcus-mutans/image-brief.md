# Image brief — Streptococcus mutans (encyclopedia entry)

As of: 2026-09-02
From: Magnus Larsen → Marika Nowicka (slot) → Lisa (still)
Template: Marika's BRAND IMAGE SPEC §5 (10 fields). Slot and ratio are hers (preview 3:2 master 1440×960, hero 16:9 master 2400×1350); I only describe what the pictures should show, in plain words. No prompt text here — Lisa writes that.

---

**1. Slug (ASCII, language-neutral):**
`streptococcus-mutans` — files `streptococcus-mutans-preview` · `streptococcus-mutans-hero` (Jurgen's pattern; encyclopedia tree `mbf/bacteria/streptococcus-mutans/`).

**2. Article title (EN) + one-line summary:**
"Streptococcus mutans: the cavity germ that only wins if you feed it."
A sugar-loving resident of tooth plaque that, given table sugar, builds a sticky glue to hold plaque on the tooth and makes acid that dissolves enamel — the best-studied cause of cavities; no proven benefit to the person carrying it.
...
**Single idea both images must carry:** the bacterium only wins if you feed it — sugar is the trigger for both the glue and the acid; without frequent sugar it is a harmless, small resident.
...
- uk preview alt: "Ілюстрація: ланцюжки овальних бактерій тримаються в липких нитках на блідій ребристій емалі, скраю один лаймовий кристалик цукру"
- uk hero alt: "Ілюстрація: цукор розчиняється серед ланцюжків овальних бактерій на емалі; вони плетуть липкі нитки, що їх приклеюють, і виділяють кислоту, а під кислотним серпанком мінеральна поверхня слабшає"
...
- th preview alt: "ภาพประกอบ: โซ่ของแบคทีเรียทรงรีถูกยึดไว้ในเส้นใยเหนียวบนเคลือบฟันสีซีดที่เป็นสัน มีผลึกน้ำตาลสีเขียวมะนาวหนึ่งเม็ดอยู่ริมภาพ"
- th hero alt: "ภาพประกอบ: น้ำตาลละลายอยู่ท่ามกลางโซ่ของแบคทีเรียทรงรีบนเคลือบฟัน พวกมันปั่นเส้นใยเหนียวที่ยึดตัวเองไว้และปล่อยกรดออกมา และใต้หมอกกรดนั้นพื้นผิวแร่ธาตุก็คลายตัว"
- th card alt: "ทุกคนมีเชื้อฟันผุอยู่ไหม? — ชายหนุ่มหยิบลูกอมจากถุงกระดาษที่โต๊ะทำงาน"
- th card question: "ทุกคนมีเชื้อฟันผุอยู่ไหม?"
- th plate lines: "ก่อนอื่น — น้ำตาลตกลงบนคราบพลัค · จากนั้น — พวกมันปั่นกาวและสร้างกรด · ผลลัพธ์ — เคลือบฟันใต้มันละลาย"

...
keyFacts:
  - fact: "The species was moved out of the genus Clostridium in 2016 and renamed Clostridioides difficile; its closest relative shares only 94.7 % of its 16S rRNA gene sequence."
    source: s1
  - fact: "In four pooled longitudinal hospital studies, C. difficile diarrhoea developed in 3.6 % of non-colonised patients but only 1.0 % of symptomless carriers."
    source: s5
  - fact: "In a phase 2 randomised trial, spores of a non-toxigenic C. difficile strain cut recurrence from 30 % on placebo to 11 %."
    source: s4
  - fact: "US surveillance estimated 476,400 cases in 2011 and 462,100 in 2017; the adjusted total burden fell by 24 %."
    source: s3
  - fact: "In a Belgian cohort, 16 % of healthy infants carried toxigenic C. difficile in their first six months, at 10⁴ to 10⁸ cells per gram of stool, without illness."
    source: s10
  - fact: "One donor-faeces infusion resolved recurrent infection in 81 % of patients, against 31 % for vancomycin alone."
    source: s7
faq:
  - q: "Is Clostridioides difficile the same thing as Clostridium difficile?"
    a: "Yes, the same species under a newer name. Lawson and colleagues moved it out of Clostridium in 2016, because it sits in a different family from the true clostridia and shares only 94.7 % of its 16S rRNA gene with its nearest relative. Papers and lab reports still use both names."
  - q: "If it is in my stool, am I sick?"
    a: "Not necessarily, and this is the central distinction. Studies of hospitalised patients and of healthy infants both find people who carry the organism, sometimes in large numbers, with no symptoms at all. Illness depends on toxin production, on the state of the surrounding microbiota and on the host antibody response."
  - q: "Can C. difficile ever be useful?"
    a: "In one narrow, tested sense. A strain that carries no toxin genes was given as spores to patients after treatment for infection, and reduced recurrence compared with placebo. Said out loud: that was a phase 2 trial in 173 patients whose primary outcome was safety, not a licensed therapy."
  - q: "Why do antibiotics set it off?"
    a: "Antibiotics remove the gut residents that convert primary bile acids into secondary ones. Those secondary bile acids block C. difficile from germinating and growing. Take the converters away and the brake comes off — which is why restoring the community, and not only killing the organism, is what stops recurrence."
  - q: "Does a faecal transplant work?"
    a: "In recurrent infection the evidence is strong: a randomised trial was stopped early because donor-faeces infusion beat vancomycin so clearly. Caveat: it enrolled 16 patients in the infusion arm, and a later review of 38 randomised trials places transplantation and monoclonal antibodies at the top, not any single product."
sources:
  - id: s1
...
**Silent carriage goes with less disease.** That is the Shim result above: 3.6 % versus 1.0 %, and among patients who received antibiotics, 4.5 % of non-carriers versus 1.1 % of carriers [s5]. The lower risk held for carriers of non-toxigenic *and* toxigenic strains. Said out loud, in the authors' own words: the mechanism is unknown [s5].
...
The scale is national. US surveillance estimated 476,400 cases in 2011 and 462,100 in 2017; after adjustment for more sensitive testing, the total burden fell by 24 % and the health-care-associated share by 36 %, while community-associated infection did not change and neither first recurrences nor in-hospital deaths fell significantly [s3]. Progress inside hospitals; a standstill outside them.

Recurrence is this organism's defining cruelty: 25 % to 30 % of patients relapse after treatment [s4], and patients who have had one recurrence are more likely to have several [s13].

## The caveat that covers all of it

Carrying is not the same as having. Every number on this page separates those two states, and they point in opposite directions — colonisation without symptoms went with less subsequent diarrhoea [s5], while the same organism, in a gut emptied of its bile-acid converters, is a leading cause of hospital diarrhoea and death [s2]. None of that is a reason to seek the bacterium out, and none of it is advice about your own test result.

The figures also come from particular populations: US surveillance sites, Belgian infants, one Malaysian hospital. They describe those settings, not your kitchen, and carriage rates differ substantially between countries and regions [s14].

What has genuinely shifted is the direction of the work. The evidence that moved furthest was not about killing this bacterium harder. It was about restoring the community that used to hold it down [s7] [s8].

# Image brief — porphyromonas-gingivalis

As of: 2026-09-02
From: Magnus Larsen → Marika Nowicka (slot) → Lisa (still)
Template: BRAND_SLOT_BRIEF_MARIKA.md §5 (Marika, 2026-09-02). Plain words only — Lisa writes the engine side.

```
1. Slug (ASCII, language-neutral):             porphyromonas-gingivalis
2. Article title (EN) + one-line summary:      "Porphyromonas gingivalis: a gum-disease suspect healthy mouths carry" — a sugar-blind, protein-eating anaerobe from the pocket between tooth and gum; common in healthy mouths, harmful only when the pocket community tips out of balance; no benefit shown; a suspect, not a convicted cause, in arthritis and Alzheimer's.
3. Organism / structure in the preview:        Porphyromonas gingivalis, in its subgingival biofilm
   Card (person, Owner 2026-09-16):            Bodrova from `refs/characters/` · a woman in her mid-forties, a translator · her own bedroom, late at night
...
5. Preview mood (one line, warm science):      a narrow wet groove seen very close — a thin moist film clinging to a pale surface, short dark rods resting in it in navy and teal, the film catching one warm morning light; the single accent is a small deep-gold glint, the haem it lives on; ivory ground, no black, no glow. Keep the rods in the middle band so the og crop loses only air.
   Card scene (one line):                      sitting on the edge of her bed late at night with a glass of water in both hands, calm and unhurried — someone carrying an ordinary thing the headlines have made frightening
   Wardrobe and place:                         plain 2026 clothing, no logos: a plain navy cotton sleep shirt, bare feet on a rug; a small bedroom at 23:45, one bedside lamp low on the far side of the bed, warm and dim, the window black behind a half-drawn curtain
   EMPTY FIELD (where the words will sit):     the right 46 % of the frame is a plain, unbroken bedroom wall in warm lamp shade — one even, uncluttered plane. Nothing crosses it: no headboard, no picture, no shelf, no switch, no cable, no pattern. It lies inside the middle horizontal band (the top and bottom 11 % are air). She sits on the left third, head and shoulders inside that same band.
...
9. Must not appear:                            any product or packaging; any text, letters, labels, scale bars or microscope interface; no person, face or hand in either frame; blood, pus, wounds or a sore mouth — no medical horror; a tooth-and-gum cutaway diagram, or any tooth or gum drawn as a body part — the pocket is a cell-scale crevice only; branded glassware; a collage or split frame; the hero as a wider crop of the preview; black background or blue neon.
   Card frame as well (Owner 2026-09-16):      a second person; any face other than the named REF; a lab coat, scrubs, a clinic, a hospital, a dental chair, a surgery, a microscope; letters, numerals, signage, packaging text or a watermark anywhere — including on clothing, the glass, mugs, jars and in the background; any brand mark; any product of any kind, including a rinse bottle, a brush or floss; jewellery with lettering; medical horror; an open mouth, teeth, gums or a smile as the subject of the frame; any gesture toward her own jaw that reads as a symptom.
...
- en card alt: "Does carrying it mean disease? — a woman sits on the edge of her bed at night, a glass of water in both hands"
- ru card alt: "Нашли — значит, болезнь? — женщина ночью сидит на краю кровати со стаканом воды в руках"
- en card question: "Does carrying it mean disease?"
...
- uk preview alt: "Ілюстрація: пухкі темні паличкоподібні бактерії лежать у вологій плівці всередині вузької щілини, світло брижиться, зблискує золото гему"
- uk hero alt: "Ілюстрація: пухкі темні палички лежать у змішаній біоплівці кишені; коли спільнота зсувається, вони випускають ферменти, що розрізають захисні білки, а рідина, яка сочиться, приносить їм їжу"

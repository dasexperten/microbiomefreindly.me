...
```
1. Slug (ASCII, language-neutral):             akkermansia-muciniphila
                                               (encyclopedia entry → binomial slug, per Marika §1; matches the article frontmatter)

2. Article title (EN) + one-line summary:      "Akkermansia muciniphila: the microbe that eats your mucus"
                                               A gut bacterium that lives in the mucus lining of the intestine and feeds on it;
                                               in mice and one small human trial that went with a tighter barrier and better
                                               metabolic numbers — without fibre, or next to a pathogen, the same appetite thins the lining.
...
4. Morphology, in words (truth):               Short oval cells — a little longer than they are wide, rounded ends, no tails,
                                               ...
                                               so the scale cue is the mucus itself: the cells sit in a soft, translucent film
                                               that is far thicker than they are tall, and the film lies over a gently
                                               folded living surface (the gut lining) that fills the lower edge of the frame.
                                               Where a cell has been grazing, the film around it is very slightly thinner,
                                               and directly beneath, fresh mucus is being pushed up from the surface.

5. Preview mood (one line, warm science):      A pale, honey-clear mucus film in morning light, navy-teal oval cells resting

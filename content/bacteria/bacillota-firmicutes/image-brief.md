...
3. Organism / structure in the preview:        Bacillota, shown through its typical body plan: thick-walled rods, some carrying a spore, sitting on food that reached the colon undigested (the mechanism of the article — fibre and resistant starch fermented into butyrate). Amended 2026-09-16: the surface is a granule of resistant starch, named in the article, because the bacteroidota entry in the same image wave carries the plant-fibre strand
   Card (person, Owner 2026-09-16):            Menshova from refs/characters/ · a woman in her fifties, a schoolteacher · her own bathroom, beside the floor scale she has just stepped off
...
5. Preview mood (one line, warm science):      a warm field, one soft light from the side; the rods in deep navy and teal on a pale starch granule, and a single small accent where the rods have pitted the granule — a quiet, well-fed colony at work, not a threat. Light and accent as in Marika's slot-and-focus block below (2026-09-16)
   Card scene (one line):                      She has stepped off the floor scale and stands beside it, a towel over one shoulder, looking down at it entirely unimpressed — she does not believe the story told about her bacteria. The scale is a plain unmarked slab seen edge-on, its display dark and unreadable and turned away from the camera: not one digit is legible anywhere in the frame
   Wardrobe and place:                         A plain unprinted T-shirt and soft cotton trousers, bare feet, hair pushed back, no logos and no gown; a small tiled bathroom at dusk, the window already blue, one warm wall light on at the side, the air still faintly damp
   EMPTY FIELD (where the words will sit):     The left 44 % of the frame is an even run of plain matte wall tiles in one flat colour, held in soft shade — nothing crosses it: no shelf, no mirror edge, no towel rail, no pipe, no socket, no pattern, no grout accent. It lies inside the middle horizontal band (top and bottom 11 % are air). She stands on the right third, head and shoulders inside that same band
...
9. Must not appear:                            any product or packaging of any brand; any letters, numbers, glyphs, labels, scale bars, bar charts or a "test report"; no person, face or hand in either frame; no capsule or supplement shape; no intestine drawn as an organ cut-away; black background, blue neon glow, false-colour microscope look; a collage, split panel or inset; blood, pus, wounds or any sick-looking gut; a hero that is a wider crop of the preview
                                               Added 2026-09-16 for the person frame: a second person of any kind; any face other than Menshova; a lab coat, scrubs, a clinic, a hospital, a microscope; letters, numerals, signage, packaging text or a watermark anywhere — including a readable scale display, a dial, a measuring tape, clothing print, bottles and in the background; any brand mark; any product; jewellery with lettering; medical horror

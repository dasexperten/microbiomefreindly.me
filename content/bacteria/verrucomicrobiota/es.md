---
title: "Verrucomicrobiota: el comedor de moco que quieres en tu intestino"
meta: "Verrucomicrobiota, antes Verrucomicrobia, es el filo intestinal de Akkermansia muciniphila. Qué hace por ti el comedor de moco, y qué hace en tu contra."
...
asOf: 2026-09-02
seo:
  keyword: "verrucomicrobiota"
  volume: 10
  market: "MX (Ubersuggest locId 2484)"
  pulled: "2026-09-16"
author: magnus-larsen
voice: greger
answer: "Verrucomicrobiota (antes Verrucomicrobia) es un filo bacteriano cuyo miembro más conocido, Akkermansia muciniphila, vive en la capa de moco de tu colon y se la come. Con moderación, esa renovación alimenta la pared intestinal y se asocia a mejores marcadores metabólicos. En exceso, o con poca fibra en la dieta, el mismo apetito adelgaza la barrera."
keyFacts:
  - fact: "Akkermansia muciniphila, el miembro mejor estudiado del filo, se aisló de heces humanas usando mucina gástrica como única fuente de carbono y nitrógeno, y se nombró en 2004."
    source: s1
  - fact: "Un recuento con sondas en heces humanas situó a A. muciniphila por encima del 1 % de todas las células fecales, lo que la vuelve una residente habitual y no una rareza."
    source: s2
  - fact: "En un ensayo piloto con 32 personas que lo terminaron, tres meses de A. muciniphila pasteurizada mejoraron la sensibilidad a la insulina un 28,62 % y resultaron seguros y bien tolerados."
    source: s5
  - fact: "En ratones gnotobióticos, añadir A. muciniphila junto a Salmonella Typhimurium empeoró la inflamación y dejó de 2 a 3 veces menos células caliciformes llenas de mucina."
    source: s7
  - fact: "En 181 muestras de suelo se detectaron Verrucomicrobia en 180, y en los horizontes superficiales promediaron el 23 % de las secuencias bacterianas: mucho más de lo que sugerían los estudios anteriores."
    source: s12
faq:
  - q: "¿Verrucomicrobiota es buena o mala para mí?"
    a: "Las dos cosas, según la cantidad y según el entorno. Una población moderada de Akkermansia en el moco del colon se asocia a mejor sensibilidad a la insulina y a una barrera conservada, mientras que una población desbordada, o una que trabaja en un intestino hambriento de fibra, adelgaza el moco que protege la pared. Es una especialista, ni heroína ni villana."

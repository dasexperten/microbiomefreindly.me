# Image brief — chewing-gum-enzymes-oral-acetaldehyde

As of: 2026-09-02
From: Magnus Larsen → Marika Nowicka (slot and focus) → Otto (hero) · Lisa (preview)

Plain words only. I do not write engine instructions — Lisa does that. Fields follow Marika's
template in the Brand Studio slot brief (§5): 1–5 make the preview, 6–8 the hero, 9–10 both.

---

**1. Slug (ASCII, language-neutral)**
chewing-gum-enzymes-oral-acetaldehyde

**2. Article title (EN) + one-line summary**
"The carcinogen your own mouth makes out of ordinary sugar" — microbes cultured from the saliva
of head-and-neck cancer patients turned sugar and alcohol into acetaldehyde, a Group 1
carcinogen; the sticky plaque shell protected the ones hiding inside it until added enzymes
dissolved that shell. Laboratory work only, no human trial.

**3. Organism / structure in the preview**
The dental biofilm itself — the sticky plaque shell — with the mouth organisms of this study held
...
Fusobacterium nucleatum: slender spindle-shaped rods, tapering to a point at both ends.
Porphyromonas gingivalis: short blunt rods, almost egg-shaped, single or in pairs.
All of them embedded in a translucent, slightly stringy film that clings to a pale, faintly
ridged hard surface — tooth enamel seen from very close, glass-smooth and warm, not white-bright.
Scale cue: the enamel surface runs across the frame with its shallow ridges readable, so the eye
understands that the beaded chains sitting in the film are far smaller than one of those ridges.

**5. Preview mood (one line, warm science)**
Morning light through a strand of clear sticky film on ivory — the film reads as a closed shelter,
with one place near the edge where it has thinned and let the light through to the cells beneath.
...
cells sheltered inside the sticky plaque shell survived until added enzymes dissolved that shell. Laboratory dishes only.

**7. Three beats (first → next → outcome)**
1. On a pale enamel plain, a sticky translucent shell holds chains of small round streptococci and budding oval yeast
   cells; plain sugar grains reach it, and a faint haze of acetaldehyde lifts from the film.
2. The peptide washes over: the haze stops and most of the chained cells lie pale, whole and inert — but a few round
   cells deep under the intact shell stay alive.
3. Outcome: enzymes dissolve the shell into loose, parting strands, the sheltered survivors lie exposed, and the peptide
   finishes them — the enamel plain is left quiet and bare.

**8. The one number (keyFacts, source id)**
Protegrin-1 with bean gum killed only **91.37 %** of the biofilm-forming streptococcal colonies; dextranase and mutanase
were needed for the rest (`s1`, Molecular Therapy: Oncology 2026). Shown only as proportion: of exactly thirty-five
round cells in the chains at the peptide stage, three stay alive, all tucked deep under the unbroken shell. Never printed.

**9. Must not appear (either image)**
No product of any kind — no chewing gum, tablet, tube, box, brush, floss, bottle, no invented
packaging, nothing product-shaped even in the background: no stick, strip, pellet or wrapper shape. No branded or
brand-looking lab glassware, no maker's marks on instruments. No person, face or hand in either frame. No letters,
numbers, glyphs, labels, scale bars or microscope interface anywhere in the pixels. No collage, no split panel, no
inset, no second frame. No medical horror — no blood, pus, wounds, no diseased mouth; the enamel is a cell-scale mineral
surface, never a tooth or jaw drawn as a body part. No blue neon, no black background, no false-colour
...
- en preview alt: "Illustration: chains of round bacteria and budding yeast held in a sticky film over pale enamel, one thinned spot lit lime"
...
**Priority**
News — this week. The article is dated 2026-09-02 and publishes with the paper still fresh.

**The single idea both images must carry**
The harm is made on site, out of ordinary sugar, and the sticky shell is what keeps it beyond
reach — open the shell and the source stops.

**The mechanism in one sentence, for Lisa's understanding**
Mouth microbes turn the sugar and alcohol passing through the mouth into acetaldehyde, a Group 1
carcinogen, and the ones living inside the sticky plaque shell survive anything poured over them
until enzymes dissolve that shell and expose them.

**File-name keyword (Jurgen's pattern)**
chewing-gum-enzymes-oral-acetaldehyde-preview · chewing-gum-enzymes-oral-acetaldehyde-hero
...
- uk preview alt: "Ілюстрація: ланцюжки круглих бактерій і брунькуючі дріжджі тримаються в липкій плівці над блідою емаллю, одна стоншена пляма світиться лаймом"
- uk hero alt: "Ілюстрація: мікроби в оболонці нальоту на емалі виділяють ацетальдегід; пептид спиняє більшість, три захищені клітини виживають, доки ферменти не розчинять оболонку"
...
- th preview alt: "ภาพประกอบ: โซ่ของแบคทีเรียทรงกลมและยีสต์ที่กำลังแตกหน่อ ถูกยึดไว้ในฟิล์มเหนียวเหนือเคลือบฟันสีซีด มีจุดหนึ่งที่บางลงต้องแสงเป็นสีเขียวมะนาว"
- th hero alt: "ภาพประกอบ: จุลินทรีย์ในเปลือกคราบพลัคบนเคลือบฟันปล่อยอะเซตัลดีไฮด์ออกมา เปปไทด์ทำให้ส่วนใหญ่สงบลง แต่มีสามเซลล์ที่หลบอยู่รอดมาได้จนกระทั่งเอนไซม์ละลายเปลือกนั้นออก"
- th card alt: "น้ำตาลก่อมะเร็งช่องปากไหม? — หญิงคนหนึ่งอยู่บนระเบียงตอนดึก กำลังเคี้ยวอะไรอยู่ มือถือแก้วไวน์"
- th card question: "น้ำตาลก่อมะเร็งช่องปากไหม?"
- th plate lines: "ก่อนอื่น — น้ำตาลและแอลกอฮอล์ไปถึงคราบพลัค · จากนั้น — จุลินทรีย์สร้างสารก่อมะเร็ง · ผลลัพธ์ — เปปไทด์ฆ่าได้ 91.37 % ไม่ใช่ทั้งหมด"
